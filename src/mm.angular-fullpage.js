/*!
 * mm.angular-fullPage 1.3.9
 * https://github.com/mmautomatizacion/mm.angular-fullpage.js.git
 * @license MIT licensed
 *
 * Based in jQuery fullPage 2.9.7 by Alvaro Trigo (https://github.com/alvarotrigo/fullPage.js)

 *
 * Copyright (C) 2017 Manuel Martínez Automatización y Pesaje Industrial and Alvaro Trigo
 */
        ...
        function fullpage(element, scope) {
            ...
            function setResponsive(active){
                ...
                if(active){
                    if(!isResponsive){
                        ...
                        $rootScope.$emit('fp-afterResponsive', isResponsive);
                    }
                }
            ...
            */
            ...
            function keydownHandler(e) {
                ...
                else if(!activeElement.is('textarea') && !activeElement.is('input') && !activeElement.is('select') && activeElement.attr('contentEditable') !== "true" && activeElement.attr('contentEditable') !== '' &&
